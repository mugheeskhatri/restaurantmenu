...
const Index = () => {
  ...
  const radioBtnOptions = ['ASAP ~ 30 Minutes', 'Later']
          ...
          <div className="delivery_time_section">
            ...
            <div className="radio_btn_section">
              {radioBtnOptions.map((v, i) => {
                return (
                  <div
                    onClick={() => setRadioSelected(v)}
                    className="radio_btn d-flex align-items-center">
                    <div
                      style={{
                        borderColor: hightlitedColor,
                        backgroundColor:
                          radioSelected === v ? hightlitedColor : 'transparent',
                      }}
                      className="icon_sectin">
